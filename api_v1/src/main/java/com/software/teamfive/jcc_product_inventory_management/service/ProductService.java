...
public class ProductService {
    ...
    @Autowired
    public ProductService(ProductRepository productRepository, UserRepository userRepository, CompanyMemberRepository companyMemberRepository, CompanyRepository companyRepository) {
    ...
    public Product createNew(CreateProductRequest request) {
        ...
        // Optional: ensure user is a member of the company
    ...
    @Transactional
    public Product updateProduct(UUID productId, @Valid UpdateProductPutRequest request) {
